 ...
 *       &lt;sequence>
 *         &lt;element name="RiskContact" type="{http://domgen.com/plan/schema/1_0}ContactDetailsType" minOccurs="0"/>
...
@XmlRootElement(name = "ApplianceGroupWithContactType")
public class ApplianceGroupWithContactType {

    @XmlElement(name = "RiskContact")
    protected ContactDetailsType riskContact;
     ...
     *     
     */
    public ContactDetailsType getRiskContact() {
        return riskContact;
    }
     ...
     *     
     */
    public void setRiskContact(ContactDetailsType value) {
